...
export default function NotFoundWatched() {
  return (
    <div className="w-1/2 h-svh mx-auto py-10">
      <p className="text-center text-lg text-zinc-400 leading-10 tracking-wide">
        It seems you have not any watched movies now. Let&#39;s change it! There
        are so many worlds to discover, so many stories to see and so many
        heroes to love or hate. Step back and choose from{" "}
        <Link
          href="/"
